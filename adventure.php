...
<body>
    ...
    <div class="center">
        <div class="list-group">
            <a href="#blink" data-toggle="collapse" class="list-group-item">"<strong>blink:The Power of Thinking Without Thinking</strong>"</a>
            <div id="blink" class="panel-collapse collapse">
                <div class="detail">
                    ...
                    <div class="space">
                        ...
                        <p>
                            "Blink: The Power of Thinking Without Thinking (2005)<br /> is Malcolm Gladwell's second book.
                        </p>
                        <div class="bottoma">
                            <ul>
                                <?php
            ...
            <a href="#meluha" data-toggle="collapse" class="list-group-item">"<strong>the immortals ofmeluha</strong>"</a>
            <div id="meluha" class="panel-collapse collapse">
                <div class="detail">
                    ...
                    <div class="space">
                        ...
                        <p>
                            "The Immortals of Meluha is the first novel of<br /> the Shiva trilogy series by Amish Tripathi.
                        </p>
                        <div class="bottoma">
                            <ul>
                                <?php
            ...
            <a href="#throne" data-toggle="collapse" class="list-group-item">"<strong>a game of throne</strong>"</a>
            <div id="throne" class="panel-collapse collapse">
                <div class="detail">
                    ...
                    <div class="space">
                        ...
                        <p>
                            "A Game of Thrones is the first novel in A Song of Ice and Fire,
                            <br /> a series of high fantasy novels.
                        </p>
                        <div class="bottoma">
                            <ul>
                                <?php
            ...
            <a href="#watchman" data-toggle="collapse" class="list-group-item">"<strong>go set a watchman</strong>"</a>
            <div id="watchman" class="panel-collapse collapse">
                <div class="detail">
                    ...
                    <div class="space">
                        ...
                        <p>
                            "Go Set a Watchman is a novel by Harper Lee<br /> published on July 14, 2015,<br />
                            by HarperCollins in the United States<br /> and William Heinemann in the United Kingdom.
                        </p>
                        <div class="bottoma">
                            <ul>
                                <?php
            ...
            <a href="#warz" data-toggle="collapse" class="list-group-item">"<strong>world war z</strong>"</a>
            <div id="warz" class="panel-collapse collapse">
                <div class="detail">
                    ...
                    <div class="space">
                        ...
                        <p>
                            "World War Z: An Oral History of the Zombie War is <br /> an apocalyptic horror novel by Max Brooks.
                        </p>
                        <div class="bottoma">
                            <ul>
                                <?php
            ...
            <a href="#watership" data-toggle="collapse" class="list-group-item">"<strong>watership down</strong>"</a>
                ...
                <div class="detail">
                    ...
                    <div class="space">
                        ...
                        <p>
                            ...
                            <br /> English author Richard Adams.
                        </p>
                        <div class="bottoma">
                            <ul>
                                <?php
